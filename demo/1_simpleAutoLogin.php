...
echo 'After Login 1(with_cookie): ' . $autologin->getUrl($getDataUrl) . "\n";
echo 'After Login 2(with_cookie): ' . $autologin->getUrl($getDataUrl) . "\n";
$autologin->removeLastCookie();
echo 'After Login 3(without_cookie): ' . $autologin->getUrl($getDataUrl) . "\n";

...
echo "timeout in 1's fail: ", substr(curlPage($url, $post, $header, false, false, 1), 0, 100) , "\n";
...
$imgContent = curlPage($url, false, false, $saveCookieFile);
...
echo "use cookie is ok: ", curlPage($url, $post, false, false, $saveCookieFile) , "\n";
